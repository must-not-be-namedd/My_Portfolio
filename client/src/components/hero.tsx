      ...
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        <AnimatedSection className="order-2 lg:order-1">
          <motion.h1 
            ...
            className="text-5xl lg:text-6xl font-bold text-foreground mb-6 leading-tight gradient-text text-glow"
          >
            Khushi Nataraj
          </motion.h1>
        ...
        <AnimatedSection delay={0.3} className="order-1 lg:order-2">
          ...
          >
            <img
              ...
              className="w-full h-96 lg:h-[500px] object-cover rounded-2xl shadow-2xl floating glow-effect neon-border"
            />
